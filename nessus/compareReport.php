...
$isPlugInfo = $_POST["isPlugInfo"]; #includes ID, Version, Publish Date, & Modification Date
$isPlugOut = $_POST["isPlugOut"];
...
$report1_temp = explode(":", $_POST["report1"]);
$agency1 = $report1_temp[0];
$report_name1 = $report1_temp[1];
$scan_start1 = $report1_temp[2];
$scan_end1 = $report1_temp[3];

$report2_temp = explode(":", $_POST["report2"]);
$agency2 = $report2_temp[0];
$report_name2 = $report2_temp[1];
$scan_start2 = $report2_temp[2];
$scan_end2 = $report2_temp[3];
...
SELECT DISTINCT
		nessus_tags.hostname, 
		nessus_results_pluginID 
FROM 
	nessus_results
INNER JOIN nessus_tags ON nessus_results.tagID = nessus_tags.tagID 
WHERE
...
compare the plugins found to see which ones are fixed
if in array A but not array B
compare the plugins found to see which ones are new
if in array B but not array A
compare the plugins found to see which are the same
in both array A and array B

Run a normal report but when it comes to listing teh hosts that are vulnerable if they show up in the FIXED array then change the color of the row and state FIXED.
*/
?>
...
<head>
 ...
 http-equiv="content-type">
  <title><?php echo "$agency1 - Nessus Vulnerability Report - $report_name1";?></title>
...
$diff_seconds = $scan_end1 - $scan_start1;
...
$where_data = array($agency1, $report_name1, $scan_start1, $scan_end1);
...
<?php if($isCvss == "yes"){ ?>
 <tr>
	...
	<td class="right" align="center" width="20%"><p><?php echo "$cvss_vector"; ?></p></td>
  </tr>
<?php }	?>
</table>

<table width="100%" class="main">
<?php if($isSynopsis == "yes"){ ?>
 <tr>
...
<?php if($isSeeAlso == "y" && $see_alsoList[1] != ""){ ?>
  <tr>
	...
	<td class="right">
	<p><?php
		foreach ($see_alsoList as $see_also){
			echo "<a href=\"$see_also\" target=\"_blank\">$see_also</a><br>";
		}
	?></p>
	</td>
  </tr>
...
?>
  <tr>
	<td class="left"><p>IAVA:</p></td>
	<td class="right">
	<?php
		if($listCount>5){ echo "<div class=\"text-container\"><div class=\"text-content short-text\">";}
		foreach ($iavaList as $iava){
			if($iava != ""){
				echo "$iava<br>";
			}//end if
		}
...
?>
  <tr>
	<td class="left"><p>CWE:</p></td>
	<td class="right">
	<?php
		if($listCount>5){ echo "<div class=\"text-container\"><div class=\"text-content short-text\">";}
		foreach ($cweList as $cwe){
			if($cwe != ""){
			echo "<a href=\"http://cwe.mitre.org/data/definitions/$cwe.html\" target=\"_blank\">$cwe</a> (http://cwe.mitre.org/data/definitions/cwe.html)<br>";
			}//end if
		}
		if($listCount>5){echo "</div><div class=\"show-more\"><a href=\"#\">Show more</a></div></div>";}
	?>
...
?>
  <tr>
	...
	<?php
		if($listCount>5){ echo "<div class=\"text-container\"><div class=\"text-content short-text\">";}
		foreach ($secuniaList as $sec){
			if($sec != ""){
			echo "<a href=\"http://secunia.com/advisories/$sec/\" target=\"_blank\">$sec</a> (http://secunia.com/advisories/$sec/)<br>";
			}//end if
		}
		if($listCount>5){echo "</div><div class=\"show-more\"><a href=\"#\">Show more</a></div></div>";}
	?>
...
?>
  <tr>
	...
	<?php
		if($listCount>5){ echo "<div class=\"text-container\"><div class=\"text-content short-text\">";}
		foreach ($edbList as $edb){
			if($edb != ""){
			echo "<a href=\"http://www.exploit-db.com/exploits/$edb/\" target=\"_blank\">$sec</a> (http://www.exploit-db.com/exploits/$edb/)<br>";
			}//end if
		}
		if($listCount>5){echo "</div><div class=\"show-more\"><a href=\"#\">Show more</a></div></div>";}
	?>
...
$data = array($pluginID, $agency1, $report_name1, $scan_start1, $scan_end1);
  ...
  <tr>
	...
	<td class="right">
		...
		<tr>
		  ...
		  <?php 
			KeyValueLookup($result_notFixed_byHost, $host_name, $pluginID);
				echo "<td class=\"right\"><p>";
					if($ip_addr == ""){ echo "$host_name";} else {echo"$ip_addr";}
				echo "</p></td>";
		...
		<?php if($isPlugOut == "yes" && $plugin_output != ""){ 
			echo "<tr><td class=\"right\" colspan=\"";
				...
				echo "$number";
			echo "\"><pre>$plugin_output</pre></td></tr>";
		} ?>
		<?php
		}//end while
		?>
...
<?php if($isPlugInfo == "yes"){ ?>
<table width="100%" class="main">
  <tr>
	<td class="top" width="15%" align="right"><p>Plugin ID</p></td>
	<td class="right" width="10%" align="center"><p><?php echo "$pluginID"; ?></p></td>
	<td class="top" width="15%" align="right"><p>Version</p></td>
	<td class="right" width="10%" align="center"><p><?php echo "$script_version"; ?></p></td>
	<td class="top" width="15%" align="right"><p>Publish Date</p></td>
	<td class="right" width="10%" align="center"><p><?php echo "$plugin_publication_date"; ?></p></td>
	<td class="top" width="15%" align="right"><p>Revision Date</p></td>
	<td class="right" width="10%" align="center"><p><?php echo "$plugin_modification_date"; ?></p></td>
  </tr>	
</table>
<?php } ?>
