	...
	<table cellspacing="5" cellpadding="5" width="600">
		<tr>
			<td colspan="2">
				...
				<p>The Nessus .nessus v2 file will be uploaded, parsed, and added to the backend MySQL database.  Reports can then be generated from the information in the database.</p>
			</td>
		</tr>
		<tr>
			<td><p>Select .nessus v2 file: </p></td><td><input name="userfile" type="file" /></td>
		</tr>
		<tr>
