...
<table style="text-align: left; width: 950px;" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="2">
	  <form action="edge3.php" method="post">
	  <p align="center">[ Nexpose Reports ]</p>
	  <p align="center">Select Agency/Report name that you want to generate a report for.</p>
  	  <select NAME="agency">
			<?php
			while($agency_row = $agency_stmt->fetch(PDO::FETCH_ASSOC)){
				echo "<option value='" . $agency_row["agency"] . "xxxxXXXXxxxx" . $agency_row["scan_id"] . "'>" . $agency_row["agency"] . ":" . $agency_row["scan_name"] . "</option>";
			}
			?>
	  </select>
