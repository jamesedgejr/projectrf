...
echo $ipaddress . ":" . $portnumber . "<br>";
  foreach($uniqueSA as $sA){
	list($manuf, $color) = split(":", $sA);
    fwrite($y, "
      <Style id=\"$sA\">
         <IconStyle>
          <Icon>
            <href>http://www.jedge.com/images/icons/$color.png</href>
          </Icon>
         </IconStyle>
        <BalloonStyle>
          <text><![CDATA[
            <img src=\"http://www.jedge.com/images/icons/" . $manuf . "_128.png\" height=\"80\">
            <br/>
...
function writeClient($wc_mac, $wc_manuf, $wc_clients){
    if(preg_match("/nintendo/i", $wc_manuf)){
		$wc_clients .= "<img src=\"http://www.jedge.com/images/icons/nintendo_128.png\" height=\"25\" align=left vspace=1 hspace=1>" . $wc_mac . "<br>" . $wc_manuf . "<br>";
	}
	elseif(preg_match("/apple/i", $wc_manuf)){
          $wc_clients .= "<img src=\"http://www.jedge.com/images/icons/powerbook_128.png\" height=\"25\" align=left vspace=1 hspace=1>" . $wc_mac . "<br>" . $wc_manuf . "<br>";
	}
	elseif(preg_match("/hon/i", $wc_manuf)){
          $wc_clients .= "<img src=\"http://www.jedge.com/images/icons/iphone_128.png\" height=\"25\" align=left vspace=1 hspace=1>" . $wc_mac . "<br>" . $wc_manuf . "<br>";
	}
	elseif(preg_match("/rim/i", $wc_manuf) || preg_match("/research/i", $wc_manuf)){
          $wc_clients .= "<img src=\"http://www.jedge.com/images/icons/blackberry_128.png\" height=\"25\" align=left vspace=1 hspace=1>" . $wc_mac . "<br>" . $wc_manuf . "<br>";
	}
	else {
		$wc_clients .= "<img src=\"http://www.jedge.com/images/icons/laptop_128.png\" height=\"25\" align=left vspace=1 hspace=1>" . $wc_mac . "<br>" . $wc_manuf . "<br>";
	}
	return $wc_clients;
}
...
fwrite($fh, "   <description><![CDATA[
					<p><font face=\"Courier\" size=\"-2\">Edge Wardrive WRT54GL Custom<br>
...
echo "<p>Click <a href=\"http://maps.google.com/maps?f=q&source=s_q&hl=en&geocode=&q=http:%2F%2Fwww.jedge.com%2Fkmlfiles%2F$filename.kml\">here</a> to view the data in Google Maps</p>";
?>
