...
<table width="100%"><tr>
	...
	<table cellspacing="5" cellpadding="5" width="600">
		<tr>
			<td colspan="2">
				<form enctype="multipart/form-data" action="kismet2kml_newcore.php" method="POST">
		...
		<tr>
			<td><p>External IP Address: </p></td><td><input name="ipaddress" type="text"></td>
		</tr>
		<tr>
			<td><p>Web Host Port Number: </p></td><td><input name="portnumber" type="text"></td>
		</tr>
		<tr>
			<td></td>
			<td>
